...
The project combines Python-based data analysis, machine learning, and Power BI dashboards to generate actionable business insights.
...
├── data/
│   ├── Bookings.csv
│   └── ola_cleaned_data.csv
│
├── notebooks/
│   └── ola_analysis.ipynb
│
├── visuals/
│   ├── daily_booking_trend.png
│   ├── revenue_by_vehicle.png
│   ├── payment_method_distribution.png
│   ├── cancellation_by_vehicle.png
│   └── cancellation_by_payment.png
│
├── powerbi/
│   └── Ola_Dashboard.pbix
│
...
The insights generated can support data-driven decision-making to improve efficiency, customer satisfaction, and revenue growth.
